...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-03-2019 a las 13:56:24
...
INSERT INTO `anotacion` (`id`, `tecnico`, `descripcion`, `fecha_hora`, `incidencia`) VALUES
(1, 1, 'Intenta apagar la impresora y volver a encenderla.', '2019-03-20 12:20:00', 1),
(10, 2, 'no tiene muy buena pinta todo esto e.e', '2019-03-05 12:55:32', 9),
(11, 1, 'hola', '2019-03-06 08:18:35', 9),
(12, 1, 'sdfdsd', '2019-03-06 11:34:50', 9);
...
(12, 'Alexs', 'Luiz', 'alex@gmail.com', '945738482');
...
(9, 'Problemas', 'en serioooo', '2019-03-04 12:06:55', 4, 'Cerrada', 5, 2, 12),
(12, 'prueba', 'prueba cerrar', '2019-03-07 02:10:00', 3, 'Cerrada', 1, 2, 1);
...
ALTER TABLE `anotacion`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_incidencia_anotacion` (`incidencia`),
  ADD KEY `fk_usuario_anotacion` (`tecnico`);
...
--
ALTER TABLE `anotacion`
  ADD CONSTRAINT `fk_incidencia_anotacion` FOREIGN KEY (`incidencia`) REFERENCES `incidencia` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_usuario_anotacion` FOREIGN KEY (`tecnico`) REFERENCES `usuario` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
