 ...
 */
final class Version20190228105715 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE incidencia CHANGE tecnico tecnico INT NOT NULL, CHANGE fecha_hora fecha_hora DATE NOT NULL, CHANGE prioridad prioridad INT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE incidencia CHANGE fecha_hora fecha_hora DATETIME NOT NULL, CHANGE prioridad prioridad VARCHAR(25) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE tecnico tecnico INT DEFAULT NULL');
