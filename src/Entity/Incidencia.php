...
class Incidencia extends ServiceEntityRepository
{
    ...
    public function getAll(){
        ...
        $sql = 'SELECT id, descripcion_breve, descripcion_detallada, fecha_hora,
                ...
                FROM incidencia WHERE estado = "Abierta"';
    ...
    public function getAllCerradas(){
        ...
        $sql = 'SELECT id, descripcion_breve, descripcion_detallada, fecha_hora,
                ...
                (SELECT nombre from categoria WHERE id = categoria) as categoria,
                (SELECT nombre from usuario WHERE id = tecnico) as tecnico, cliente
                FROM incidencia WHERE estado = "Cerrada"';
    ...
    public function getAllTecnico(){
        ...
        $sql = 'SELECT id, descripcion_breve, descripcion_detallada, fecha_hora,
                ...
                (SELECT nombre from categoria WHERE id = categoria) as categoria,
                (SELECT nombre from usuario WHERE id = tecnico) as tecnico, cliente
                FROM incidencia WHERE estado = "Abierta" and tecnico = :idTecnico';
    ...
    public function getDesc($busqueda){
        ...
        $sql = 'SELECT id, descripcion_breve, descripcion_detallada, fecha_hora,
                ...
                (SELECT nombre from usuario WHERE id = tecnico) as tecnico, cliente
                FROM incidencia
                WHERE descripcion_breve LIKE "%'.$busqueda.'%" and estado = "Abierta"';
    ...
    public function getFecha($busqueda){
        ...
        $sql = 'SELECT id, descripcion_breve, descripcion_detallada, fecha_hora,
                ...
                (SELECT nombre from usuario WHERE id = tecnico) as tecnico, cliente
                FROM incidencia
                WHERE fecha_hora LIKE "%'.$busqueda.'%" and estado = "Abierta"';
    ...
    public function getPrioridadBusqueda($busqueda){
        ...
        $sql = 'SELECT i.id, i.descripcion_breve, i.descripcion_detallada, i.fecha_hora, p.nombre as prioridad, i.estado,
                ...
                WHERE i.prioridad = p.id and p.id = :idPrioridad and estado = "Abierta"';
    ...
    public function getCategoriaBusqueda($busqueda){
        ...
        $sql = 'SELECT i.id, i.descripcion_breve, i.descripcion_detallada, i.fecha_hora,
                ...
                WHERE i.categoria = c.id and c.id = :idCategoria and estado = "Abierta"';
    ...
    public function update(){
        ...
        $sql = 'UPDATE incidencia SET tecnico=:tecnico WHERE id = :id';
    ...
    public function getAllAbiertasCategoria(){

        $conn = $this->getEntityManager()->getConnection();

        $sql = 'SELECT (SELECT nombre FROM categoria WHERE id = categoria) as categoria,
    ...
    public function getAllCerradasCategoria(){
    ...
    public function getAllCerradasTecnicos(){

        $conn = $this->getEntityManager()->getConnection();

        $sql = 'SELECT (SELECT nombre FROM usuario WHERE id = tecnico) as tecnico ,COUNT(tecnico) as cantidad
                FROM incidencia
                WHERE estado = "Cerrada"
                GROUP BY tecnico
                LIMIT 5';
